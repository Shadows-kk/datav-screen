...
// 模拟年龄数据
const ageMockData = [{ "startValue": 0, "value": 131107, "axis": "0-20", "color": "rgba(116, 166, 49)" },
  { "startValue": 0, "value": 330831, "axis": "20-30", "color": "rgba(190, 245, 99)" },
  { "startValue": 0, "value": 551238, "axis": "30-50", "color": "rgba(202, 252, 137)" },
  { "startValue": 0, "value": 31008, "axis": ">50", "color": "rgba(251, 253, 142)" }]
//  设备数据
...
// 骑手数据
const riderMockData = { "axisX": ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'], "orderData": { "legned1": "去年骑手接单", "legned2": "今年骑手接单", "data1": ["330", "420", "560", "450", "610", "890", "720", "610", "580", "750", "770", "600"], "data2": ["430", "510", "660", "550", "710", "990", "620", "550", "760", "810", "930", "720"] }, "rateData": { "legned1": "去年新增骑手", "legned2": "今年新增骑手", "data1": ["129", "223", "202", "197", "300", "112", "333", "249", "178", "322", "401", "167"], "data2": ["179", "263", "282", "297", "330", "344", "222", "299", "190", "455", "566", "233"] } }
// 热门食品
...
export default function() {
  ...
  const growthLastMonth = ref(15.16);
  ...
  onMounted(() => {
    task = setInterval(() => {
      todayUser.value = todayUser.value + 100
      growthLastDay.value = growthLastDay.value + 0.1
      growthLastMonth.value = growthLastMonth.value + 0.1
      averageAge.value = averageAge.value + 1
      //  这里修改的数据是在对象中，需要通过浅拷贝来进行修改，然后重新赋值
      ...
      _deviceData.totalDevices += Math.floor(Math.random() * 100)
